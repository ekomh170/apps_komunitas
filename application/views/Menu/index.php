...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-dark"><b>Menu User</b></h1>
    <p></p>
    <!--<p lass="mb-4"></p>-->
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-dark">Database Menu</h6>
        </div>
        <div class="card-body">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url(); ?>Menu/ubah/<?= $mn['id']; ?>"><button type="button" class="btn btn-success"><i class="fas fa-fw fa-check"></i></button></a></i></a> <b>|</b>
                                <a href="<?= base_url(); ?>Menu/hapus/<?= $mn['id']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini ??');"><button type="button" class="btn btn-danger"><i class="fas fa-fw fa-trash"></i></button></a></a>
                            </td>
                        </tr>
                    <?php $no++ ?>
                    <?php endforeach; ?>
