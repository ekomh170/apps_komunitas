             ...
             <div class="col-md-12">
                <div class="d-flex w-100 mb-3">
                        <div class="couting">
                            ...
                            <div>
                                <a href="<?= base_url(); ?>Post/add" class="btn btn-success">Tambah Diskusi</a>
                            </div>
                            <div class="mb-1"></div>
                            <div>  
                                <a href="<?= base_url(); ?>Post" class="btn btn-success  align-self-start">Back</a>
                            </div>
                        </div>
                    </div>
                    <?php foreach ($data_post as $value) { ?>
                            ...
                            <img src="<?= base_url('assets/img/') . $value->image ?>" height="200" width="200"></img>
                                ...
                                <div class="w-100 p-3 text-left">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h3 class="mb-1"><a
                                            href="<?= base_url('post/') . $value->id_post?>"><?= $value->judul_post ?></a>
                                        </h3>
                                        <div>
                                            <small>
                                                <?php 
                                    ...
                                    <a href="" class="text-decoration-none">
                                        ...
                                        <small><a href="<?= base_url(); ?>Saran/hapus/<?= $value->id_post; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini ??');"><button type="button" class="badge-danger    p-1 mr-1 rounded text-white "><i class="fas fa-fw fa-trash"></i></button></a></small>
                                    <?php } ?>
                                    </a>
                                </div>
                            </div>
