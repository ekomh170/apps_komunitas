        ...
        <div class="col-lg">
          <div class="p-5">
            <div class="text-center">
              ...
              <br><br>
              <h1 class="h4 text-gray-900 mb-4"><b>Buat Akun Dan Buat Komunitas</b></h1>
            </div>
            <form class="user" method="post" action="<?= base_url('Auth/register')?>">
              ...
              <div class="form-group">
                <input type="text" class="form-control form-control-user" id="nama_komunitas" name="nama_komunitas" placeholder="Nama Komunitas" value="<?= set_value('nama_komunitas'); ?>">
