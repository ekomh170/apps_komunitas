<div class="slide-one-item home-slider owl-carousel">
    <div class="site-blocks-cover overlay"
        style="background-image: url(<?= base_url('assets2/'); ?>images/hero_bg_2.jpg);" data-aos="fade"
    ...
    <div class="site-blocks-cover overlay"
        style="background-image: url(<?= base_url('assets2/'); ?>images/hero_bg_4.jpg);" data-aos="fade"
        data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-start">
                <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
    ...
    <div class="site-blocks-cover overlay"
        style="background-image: url(<?= base_url('assets2/'); ?>images/hero_bg_3.jpg);" data-aos="fade"
        data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-start">
                <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg"
                    style="background-image: url('<?= base_url('assets2/'); ?>images/img_1.jpg');">
                    <div class="text">
                        <h2 class="h5 text-white">Jangan Lupa Ikuti Event Menariknya</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos repellat autem illum nostrum sit
                            distinctio!</p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg"
                    style="background-image: url('<?= base_url('assets2/'); ?>images/img_2.jpg');">
                    <div class="text">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg"
                    style="background-image: url('<?= base_url('assets2/'); ?>images/img_3.jpg');">
                    <div class="text">
...
<div class="site-section block-13 bg-primary fixed overlay-primary bg-image"
    style="background-image: url('images/hero_bg_3.jpg');" data-stellar-background-ratio="0.5">

    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12 text-center">
                <h2 class="text-white">Ayo Gabung Komunitas</h2>
            </div>
        </div>
        <br>
        <br>
 ...
 --> <?php foreach ($data as $value) { ?>
                    <div class="col-md-6 col-lg-4">
                        <div class="p-3 p-md-5 feature-block-1 mb-6 mb-lg-0 bg"
                            style=" background-image: url('<?= base_url('assets/img/') . $value->image ?>');">
                            <div class="text">
